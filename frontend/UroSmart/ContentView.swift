...
struct LoginView: View {
    ...
    init(showSignUp: Binding<Bool>, isLoggedIn: Binding<Bool>) {
        self._showSignUp = showSignUp
        self._isLoggedIn = isLoggedIn
        
        // Load saved credentials from Keychain (secure)
    ...
    private func handleLogin() {
        Task {
            do {
                ...
                // Save credentials to Keychain (secure) if Remember Me is checked
                if rememberMe {
                    ...
                    // Remove from Keychain if Remember Me is unchecked
